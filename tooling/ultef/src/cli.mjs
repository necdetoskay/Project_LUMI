...
const commands = {
  ...
  "L2-ISOLATION-MATRIX": {
    command: "pnpm",
    args: ["--filter", "@lumi/web", "exec", "vitest", "run", "tests/ultef-isolation-matrix.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L2-ISOLATION-MATRIX" },
  },
  "L3-SESSION-NEGATIVE": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-session-negative.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L3-SESSION-NEGATIVE" },
  },
  "L3-SESSION-IDEMPOTENCY": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-session-idempotency.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L3-SESSION-IDEMPOTENCY" },
  },
  "L3-SESSION-003": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-session-single-active.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L3-SESSION-003" },
  },
  "L4-OUTCOME-REJECTION": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-outcome-rejection.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L4-OUTCOME-REJECTION" },
  },
  "L4-OUTCOME-ATOMIC-ROLLBACK": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-outcome-atomic-rollback.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L4-OUTCOME-ATOMIC-ROLLBACK" },
  },
  "L4-INDIRECT-RETRY-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/web", "exec", "vitest", "run", "tests/ultef-indirect-propagation-retry.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L4-INDIRECT-RETRY-001" },
  },
  "L4-INDIRECT-FAILURE-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/web", "exec", "vitest", "run", "tests/ultef-indirect-propagation-terminal-failure.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L4-INDIRECT-FAILURE-001" },
  },
  "L4-CHOICE-DIVERGENCE-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-choice-branch-divergence.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L4-CHOICE-DIVERGENCE-001" },
  },
  "L4-CHOICE-WORLD-DIVERGENCE-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/story", "exec", "vitest", "run", "--config", "vitest.integration.config.ts", "tests/integration/ultef-choice-world-divergence.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L4-CHOICE-WORLD-DIVERGENCE-001" },
  },
  "L5-CONTEXT-DIVERGENCE-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/web", "exec", "vitest", "run", "tests/ultef-continuity-context-divergence.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L5-CONTEXT-DIVERGENCE-001" },
  },
  "L6-CONTEXT-TO-STORY-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/web", "exec", "vitest", "run", "tests/ultef-context-to-story.integration.test.ts"],
    env: { ULTEF_SCENARIO: "L6-CONTEXT-TO-STORY-001" },
  },
  "L3-NPC-001": {
    command: "pnpm",
  ...
  "L6-GOLDEN-001": {
    command: "pnpm",
    args: ["--filter", "@lumi/web", "exec", "vitest", "run", "tests/ultef-golden-headless.integration.test.ts"],
