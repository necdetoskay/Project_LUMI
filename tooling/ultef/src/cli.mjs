...
const commands = {
  ...
  "L3-SESSION-IDEMPOTENCY": {
    ...
    args: [
      ...
      "--config",
      "vitest.integration.config.ts",
      "tests/integration/ultef-session-idempotency.integration.test.ts",
    ],
  ...
  "L4-OUTCOME-REJECTION": {
    ...
    args: [
      ...
      "--config",
      "vitest.integration.config.ts",
      "tests/integration/ultef-outcome-rejection.integration.test.ts",
    ],
  ...
  "L4-INDIRECT-RETRY-001": {
    ...
    args: [
      ...
      "vitest",
      "run",
      "tests/ultef-indirect-propagation-retry.integration.test.ts",
    ],
  ...
  "L4-INDIRECT-FAILURE-001": {
    ...
    args: [
      ...
      "vitest",
      "run",
      "tests/ultef-indirect-propagation-terminal-failure.integration.test.ts",
    ],
  ...
  "L4-CHOICE-WORLD-DIVERGENCE-001": {
    ...
    args: [
      ...
      "--config",
      "vitest.integration.config.ts",
      "tests/integration/ultef-choice-world-divergence.integration.test.ts",
    ],
  ...
  "L6-CONTEXT-TO-STORY-001": {
    ...
    args: [
      ...
      "vitest",
      "run",
      "tests/ultef-context-to-story.integration.test.ts",
    ],
  ...
  "PX-LUMI-09-001": {
    ...
    args: [
      ...
      "--config",
      "vitest.integration.config.ts",
      "tests/integration/ultef-world-commit.integration.test.ts",
    ],
  ...
  "PX-LUMI-09-002": {
    ...
    args: [
      ...
      "vitest",
      "run",
      "tests/ultef-materialized-rumor.integration.test.ts",
    ],
...
if (!spec) {
  ...
  console.error(
    `Available foundation profiles: ${Object.keys(commands).join(", ")}`,
  );
  process.exit(2);
}
