...
import { commitChoice, getStorySessionOrForbidden } from "@lumi/story/application";
...
export const POST = observeHandler(async (request: Request, { params }: { params: Promise<{ sessionId: string; choicePointId: string }> }) => {
