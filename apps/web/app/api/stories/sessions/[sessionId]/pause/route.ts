...
import { pauseSession, getStorySessionOrForbidden } from "@lumi/story/application";
  ...
  async (
    ...
    return withParent(async (parent) => {
      ...
      try {
        ...
        return handleStoryError(error, "Failed to pause session");
      }
    });
  },
  "/api/stories/sessions/{sessionId}/pause",
);
