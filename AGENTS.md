...
- Sprint 20 — Stability, Release, Performance and Reliability [planlı] (spec: `docs/07-delivery/lumi/sprint-20/SPRINT_SPEC.md`; S20-T01 scope freeze/traceability, T02 version/build artifact reproducibility, T03 migration/restore rehearsal (staging drill), T04 full release test suite (regression/security/load), T05 runbooks/monitoring/handoff, T06 RC PR/tag + approval package)
