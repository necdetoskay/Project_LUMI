...
- Sprint 22 — Story Outcome & World State Commit System [tamamlandı] (spec: `docs/07-delivery/lumi/sprint-22/SPRINT_SPEC.md`; T01 outcome manifest + snapshot, T02 extraction + evidence validation, T03 world commit rule engine, T04 transactional commit + world versioning, T05 event sourcing + compensation, T06 E2E advance→commit, T07 backlog validation; closes S10 limitation; on branch `codex/sprint-22-commit-system`)

- Sprint 23 — Indirect Effect Propagation + Outbox (spec: `docs/07-delivery/lumi/sprint-23/SPRINT_SPEC.md`; S23-T01 outbox schema + migration `0004`, T02 outbox repository, T03 rule engine indirect-intent split, T04 atomic commit+outbox, T05 propagation service (idempotent), T06 failure+retry isolation, T07 SOWS-005/014/015 evidence; closes S22 documented indirect-effect/outbox gap)
