import type {
  ...
  NewInventoryItemDefinitionRecord,
  InventoryItemInstanceRecord,
  NewInventoryItemInstanceRecord,
  InventoryRecord,
  NewInventoryRecord,
  InventoryEntryRecord,
  NewInventoryEntryRecord,
  InventoryOwnershipRecord,
  NewInventoryOwnershipRecord,
  InventoryOwnershipHistoryRecord,
  NewInventoryOwnershipHistoryRecord,
  InventoryTransferRecord,
  NewInventoryTransferRecord,
  InventoryUsageRecord,
  NewInventoryUsageRecord,
  InventoryDomainEventRecord,
  NewInventoryDomainEventRecord,
  InventoryIdempotencyLedgerRecord,
  NewInventoryIdempotencyLedgerRecord,
} from "../../../db";
...
export interface InventoryRepository {
  ...
  findEntryByInventoryAndInstance(
    inventoryId: string,
    itemInstanceId: string,
  ): Promise<InventoryEntryRecord | null>;
  findEntryByItemInstance(
    itemInstanceId: string,
  ): Promise<InventoryEntryRecord | null>;
  updateEntry(
    id: string,
  ...
  findActiveOwnershipByItem(
    itemInstanceId: string,
  ): Promise<InventoryOwnershipRecord | null>;
  findActiveOwnershipByItemForUpdate(
    itemInstanceId: string,
    tx: unknown,
  ): Promise<InventoryOwnershipRecord | null>;
