...
export const characterCreationCycles = profileSchema.table(
  "character_creation_cycles",
  {
    id: primaryId(),
...
export const characterCreationSelections = profileSchema.table(
  "character_creation_selections",
  {
    id: primaryId(),
    cycleId: uuid("cycle_id")
      .notNull()
      .references(() => characterCreationCycles.id, { onDelete: "cascade" }),
    childProfileId: uuid("child_profile_id")
      .notNull()
      .references(() => childProfiles.id, { onDelete: "cascade" }),
    householdId: uuid("household_id")
    ...
    selectionPayload: jsonb("selection_payload")
      .$type<Record<string, unknown>>()
      .notNull()
      .default({}),
    selectedBy: varchar("selected_by", { length: 20 })
