...
export const inventoryIdempotencyLedger = profileSchema.table(
  "inventory_idempotency_ledger",
  {
    ...
    resultStatus: varchar("result_status", { length: 20 }).notNull().default("completed"),
...
export type InventoryIdempotencyLedgerRecord = typeof inventoryIdempotencyLedger.$inferSelect;
export type NewInventoryIdempotencyLedgerRecord = typeof inventoryIdempotencyLedger.$inferInsert;
