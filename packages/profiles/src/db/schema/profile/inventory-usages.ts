...
export const inventoryUsages = profileSchema.table(
  "inventory_usages",
  {
    ...
    applicationStatus: varchar("application_status", { length: 20 }).notNull().default("applied"),
