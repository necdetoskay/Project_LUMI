...
export type WorldBootstrapManifestRecord = typeof worldBootstrapManifests.$inferSelect;
export type NewWorldBootstrapManifestRecord = typeof worldBootstrapManifests.$inferInsert;
