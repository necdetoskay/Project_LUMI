...
export const promptRegistriesRelations = relations(promptRegistries, ({ many }) => ({
...
export const promptActivationsRelations = relations(promptActivations, ({ one }) => ({
  registry: one(promptRegistries, {
...
export const promptActivationHistoryRelations = relations(promptActivationHistory, ({ one }) => ({
  registry: one(promptRegistries, {
